...
/**
 * Provides an abstract class to be the superclass of any number of Parsers
 * necessary for data to be initially parsed by a mapper during index
 * construction Implementations of this class should implement one of the parse
 * methods not both
 * 
 * @author Stefan Brinton
 * 
 * @param <KeyIn>
 *            Type of Key from file
 * @param <ValueIn>
 *            Type of value from file
 * @param <KeyOut>
 *            Output's Key type
 * @param <ValueOut>
 *            Output's value type
...
public abstract class Parser<KeyIn, ValueIn, KeyOut, ValueOut> {
	...
	// These two variables allow the local index constructor to know them for
	...
	/**
	 * Used to parse key-value pairs that generate a single output key-value
	 * pair
	 * 
	 * @param key
	 *            Input key
	 ...
	 * @return
	 */
	public abstract ArrayList<Pair<KeyOut, ValueOut>> arrayParse(KeyIn key,
			ValueIn value);
